...
const HTMLReaderGrey = (props: Props) => {
  return (
    <HTML
      html={props.html}
      ...
      tagsStyles={{
        ...
        p: {color: theme.color.grey, marginTop: 0, marginBottom: 10, textAlign: 'justify'},
      ...
      renderers={{
        hr: () => (
          <View style={{ width: "100%", height: 1, backgroundColor: theme.color.grey }} />
        ),
